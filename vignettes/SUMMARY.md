...
> Annotation: This file is a scaffold. Codex should replace placeholder rows with a repository-derived inventory for `vignettes/`.

## Purpose

Original R vignette and workflow documentation.

## Porting relevance

Convert workflows to Python examples, notebooks, or documentation pages.
...
|---|---|---|---|---|---|---|
| `[ ]` | `vignettes/TBD` | `TBD` | `TBD` | port/classify/defer | unassigned | Replace after inspection |

## Checklist

- [ ] Inventory every file in `vignettes/`.
