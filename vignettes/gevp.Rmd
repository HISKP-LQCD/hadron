...
\texttt{hadron} by the function \texttt{matrixfit} and, more modern,
\texttt{new\_matrixfit}. Let us discuss here the former in its
application to
...
An extended overview is provided by the overloaded \texttt{summary}
function
...
exponential to the principal correlator. For this \texttt{matrixfit}
knows the model \texttt{pc}. The corresponding fit model reads
\[
