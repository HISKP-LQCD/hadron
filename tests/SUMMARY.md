...
> Annotation: This file is a scaffold. Codex should replace placeholder rows with a repository-derived inventory for `tests/`.

## Purpose

Original R tests and test helpers.

## Porting relevance

Convert test intent to pytest and generate R reference-output fixtures.
...
|---|---|---|---|---|---|---|
| `[ ]` | `tests/TBD` | `TBD` | `TBD` | port/classify/defer | unassigned | Replace after inspection |

## Checklist

- [ ] Inventory every file in `tests/`.
