...
#' plot.massfit
#' 
#' Generic function to plot an object of type \code{massfit}
#' 
#' 
#' @param x Object of type \code{massfit}
#' @param ... Generic graphical parameter to be passed on to
#' \link{plotwitherror}
...
#' plot.pionfit
#' 
#' Generic function to plot an object of type \code{pionfit}
#' 
#' 
#' @param x Object of type \code{pionfit}
#' @param ... Generic graphical parameter to be passed on to
#' \link{plotwitherror}
...
#' plot.rhofit
#' 
#' Generic function to plot an object of type \code{rhofit}
#' 
#' 
#' @param x Object of type \code{rhofit}
#' @param ... Generic graphical parameter to be passed on to
#' \link{plotwitherror}
...
#' plot.b1fit
#' 
#' Generic function to plot an object of type \code{b1fit}
#' 
#' 
#' @param x Object of type \code{b1fit}
#' @param ... Generic graphical parameter to be passed on to
#' \link{plotwitherror}
...
#' plot.ofit
#' 
#' Generic function to plot an object of type \code{ofit}
#' 
#' 
...
#' plot.c1fit
#' 
#' Generic function to plot an object of type \code{c1fit}
#' 
#' 
#' @param x Object of type \code{c1fit}
#' @param ... Generic graphical parameter to be passed on to
#' \link{plotwitherror}
...
#' 
#' 
#' @param x Object of class \code{effmass}
...
#' plot.pionff
#' 
#' Generic function to plot an object of type \code{pionff}
#' 
#' 
#' @param x Object of type \code{pionff}
#' @param ... Generic graphical parameter to be passed on to
#' \link{plotwitherror}
