...
> Annotation: This file is a scaffold. Codex should replace placeholder rows with a repository-derived inventory for `R/`.

## Purpose

Original R implementation and main algorithmic source of truth.

## Porting relevance

Map every R file, function, S3 method, R6 class, and export to a Python target.
...
|---|---|---|---|---|---|---|
| `[ ]` | `R/TBD` | `TBD` | `TBD` | port/classify/defer | unassigned | Replace after inspection |

## Checklist

- [ ] Inventory every file in `R/`.
