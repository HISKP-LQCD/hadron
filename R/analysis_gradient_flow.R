...
#' analysis_gradient_flow
#' 
#' function to analyse the gradient flow output files generated by the tmLQCD
...
#' @param outputbasename string. basename of output files
#' @param basename string. basename of input files
#' @param read.data boolean. Indicates whether to read data fresh from data
#' files or to use \code{basename.raw.gradflow.Rdata} instead
#' @param pl boolean. If set to \code{TRUE} plots will be generated
#' @param skip integer. number of measurements to skip
#' @param start integer. start value for time
#' @param scale numeric. scale factor
#' @param dbg boolean. If set to \code{TRUE} debugging output will be provided.
