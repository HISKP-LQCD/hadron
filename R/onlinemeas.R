...
#' time series. See \code{[boot::tsboot()]} for details.
...
#' the call to \code{[boot::boot()]} if \code{method} was set correspodingly.
#' Otherwise \code{NULL}.  } \item{tsboot}{ object returned by the call to
#' \code{[boot::tsboot()]} if \code{method} was set correspodingly. Otherwise
