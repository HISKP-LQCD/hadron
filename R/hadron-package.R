...
#'
#' @name internal_hadron_functions
...
#' 
#' Sample data for a correlation function on a 48 cubed times 96
#' lattice QCD simulation representing a principal correlator
#' from a three-pion GEVP at maximal isospin. Includes bootstrap
#' samples.
#'
#' @name cA2.09.48_3pi_I3_0_A1u_1_pc
#' @docType data
#' @keywords datasets
#' @format `cf` class with `cf_meta`, `cf_boot`, `cf_principal_correlator` mixins
#' @examples
#'
#' data(cA2.09.48_3pi_I3_0_A1u_1_pc)
#' plot(cA2.09.48_3pi_I3_0_A1u_1_pc, log='y')
#' plot(bootstrap.effectivemass(cA2.09.48_3pi_I3_0_A1u_1_pc))
#' 
NULL
