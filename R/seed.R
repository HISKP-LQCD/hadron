...
#' \code{NULL}. This is useful because a function can just pass on its own
#' \code{seed} argument and therefore control whether the seed shall be fixed
#' or left as-is.
#' @return The old random seed is returned if it exists. Otherwise \code{NULL}.
#' In case that \code{new_seed} was missing, \code{NULL} is returned.
