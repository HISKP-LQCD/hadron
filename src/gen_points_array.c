...
// Usually we should set big enough value for these two parameters or the program will
// crash. For precision of 1e-8, (NPmode=40, DimMAX=72) is good enough. Actually,by my test
// NPmode=40 can be selected up to precision 1e-11 for usual case.
//
...
int gen_points_array(int **_degnrtDOF,
                     int **_arrayPmode,
                     const int NPmode,
                     const int DimMAX) {
